...
object ReportExporter {
    ...
    private fun toCsv(r: MaintenanceReport): String = buildString {
        ...
        appendLine("averageShock,${r.averageShock}")
    ...
    private fun toJson(r: MaintenanceReport): String = buildString {
        ...
        append("\"averageShock\":${r.averageShock},")
    ...
    private fun toPdfText(r: MaintenanceReport): String = buildString {
        ...
        appendLine("Validation: ${r.validationScore} · Avg Shock: ${r.averageShock} g · Max: ${r.maximumShock} g · Shocks: ${r.shockCount}")
        appendLine()
