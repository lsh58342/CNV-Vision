...
class FloorSelectFragment : BaseScreenFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        view.findViewById<TextView>(R.id.select_title).setText(R.string.nav_floor_title)
        siteVm.contextSummary.observe(viewLifecycleOwner) {
            view.findViewById<TextView>(R.id.select_subtitle).text = it
        }
        siteVm.floors.observe(viewLifecycleOwner) { list ->
